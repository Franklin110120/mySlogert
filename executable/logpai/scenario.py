...
input_dir  = 'output/dl.log/1-init' # The input directory of log file
output_dir = 'output/dl.log/2-logpai' # The output directory of parsing results
log_file   = 'dl.log.0' # The input log file name
log_format = '<Device> <LogId> <Date> <Time> <Level> <Method> <Content>' # Syslog log format
